...
export const SPECKLE_URL=process.env.REACT_APP_SPECKLE_URL
export const APP_SPECKLE_ID=process.env.REACT_APP_SPECKLE_ID
export const APP_SPECKLE_NAME=process.env.REACT_APP_SPECKLE_NAME
...
export const FS_URL=process.env.REACT_APP_API_URL
...
export async function exchangeAccessCode(accessCode) {
    try {
        var res = await fetch(`${FS_URL}/eac`, {
            method: "POST",
            headers: {
